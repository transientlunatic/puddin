"""Binary system parameter functions for gravitational-wave astronomy.

All functions in this module relate to the masses and spins of compact binary
coalescences.  They accept:
