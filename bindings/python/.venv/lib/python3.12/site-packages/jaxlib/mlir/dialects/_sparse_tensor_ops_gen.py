...
class ExtractIterSpaceOp(_ods_ir.OpView):
  ...
  def __init__(self, tensor, loLvl, hiLvl, *, parentIter=None, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def parentIter(self) -> _Optional[_ods_ir.Value]:
    return None if len(self.operation.operands) < 2 else self.operation.operands[1]

  @builtins.property
  def loLvl(self) -> _ods_ir.IntegerAttr:
    return self.operation.attributes["loLvl"]

  @loLvl.setter
  def loLvl(self, value: _ods_ir.IntegerAttr):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["loLvl"] = value

  @builtins.property
  def hiLvl(self) -> _ods_ir.IntegerAttr:
    return self.operation.attributes["hiLvl"]

  @hiLvl.setter
  def hiLvl(self, value: _ods_ir.IntegerAttr):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["hiLvl"] = value

  @builtins.property
  def extractedSpace(self) -> _ods_ir.OpResult:
    return self.operation.results[0]

@_ods_cext.register_op_adaptor(ExtractIterSpaceOp)
class ExtractIterSpaceOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.extract_iteration_space"
  ...
  @builtins.property
  def loLvl(self) -> _ods_ir.IntegerAttr:
    return self.attributes["loLvl"]

  @builtins.property
  def hiLvl(self) -> _ods_ir.IntegerAttr:
    return self.attributes["hiLvl"]

def extract_iteration_space(tensor, lo_lvl, hi_lvl, *, parent_iter=None, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
class ExtractValOp(_ods_ir.OpView):
  ...
  def __init__(self, tensor, iterator, *, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(tensor)
  ...
  @builtins.property
  def iterator(self) -> _ods_ir.Value:
...
@_ods_cext.register_op_adaptor(ExtractValOp)
class ExtractValOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.extract_value"
...
def extract_value(tensor, iterator, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ExtractValOp(tensor=tensor, iterator=iterator, results=results, loc=loc, ip=ip).result
...
class IterateOp(_ods_ir.OpView):
  ...
  @builtins.property
  def iterSpace(self) -> _ods_ir.Value:
    return self.operation.operands[0]
  ...
  @builtins.property
  def crdUsedLvls(self) -> _ods_ir.IntegerAttr:
    return self.operation.attributes["crdUsedLvls"]

  @crdUsedLvls.setter
  def crdUsedLvls(self, value: _ods_ir.IntegerAttr):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
...
@_ods_cext.register_op_adaptor(IterateOp)
class IterateOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.iterate"
  ...
  @builtins.property
  def crdUsedLvls(self) -> _ods_ir.IntegerAttr:
    return self.attributes["crdUsedLvls"]

def iterate(results_, iter_space, init_args, crd_used_lvls, *, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, IterateOp]:
...
class AssembleOp(_ods_ir.OpView):
  ...
  @builtins.property
  def levels(self) -> _ods_ir.OpOperandList:
    _ods_variadic_group_length = len(self.operation.operands) - 2 + 1
    return self.operation.operands[0:0 + _ods_variadic_group_length]

  @builtins.property
  def values(self) -> _ods_ir.Value[_ods_ir.RankedTensorType]:
    _ods_variadic_group_length = len(self.operation.operands) - 2 + 1
...
@_ods_cext.register_op_adaptor(AssembleOp)
class AssembleOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.assemble"
...
def assemble(result, levels, values, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
class BinaryOp(_ods_ir.OpView):
  ...
  @builtins.property
  def overlapRegion(self) -> _ods_ir.Region:
    return self.regions[0]

  @builtins.property
  def leftRegion(self) -> _ods_ir.Region:
    return self.regions[1]

  @builtins.property
  def rightRegion(self) -> _ods_ir.Region:
...
class BinaryOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def left_identity(self) -> bool:
    return "left_identity" in self.attributes

  @builtins.property
  def right_identity(self) -> bool:
    return "right_identity" in self.attributes

def binary(output, x, y, *, left_identity=None, right_identity=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
class CoIterateOp(_ods_ir.OpView):
  ...
  @builtins.property
  def iterSpaces(self) -> _ods_ir.OpOperandList:
  ...
  @builtins.property
  def cases(self) -> _ods_ir.ArrayAttr:
    return self.operation.attributes["cases"]

  @cases.setter
  def cases(self, value: _ods_ir.ArrayAttr):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
...
@_ods_cext.register_op_adaptor(CoIterateOp)
class CoIterateOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.coiterate"
  ...
  @builtins.property
  def cases(self) -> _ods_ir.ArrayAttr:
    return self.attributes["cases"]

def coiterate(results_, iter_spaces, init_args, crd_used_lvls, cases, num_case_regions, *, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, CoIterateOp]:
...
class CompressOp(_ods_ir.OpView):
  ...
  def __init__(self, values, filled, added, count, tensor, lvlCoords, *, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(values)
  ...
  @builtins.property
  def filled(self) -> _ods_ir.Value[_ods_ir.MemRefType]:
    return self.operation.operands[1]

  @builtins.property
  def added(self) -> _ods_ir.Value[_ods_ir.MemRefType]:
  ...
  @builtins.property
  def lvlCoords(self) -> _ods_ir.OpOperandList:
...
@_ods_cext.register_op_adaptor(CompressOp)
class CompressOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.compress"
  ...
  def lvlCoords(self) -> _ods_ir.OpOperandList:
    ...
    return self.operands[5:5 + _ods_variadic_group_length]

def compress(values, filled, added, count, tensor, lvl_coords, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def concatenate(result, inputs, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
class ConvertOp(_ods_ir.OpView):
  ...
  @builtins.property
  def dest(self) -> _ods_ir.OpResult[_ods_ir.RankedTensorType]:
    return self.operation.results[0]
...
def convert(dest, source, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
class CrdTranslateOp(_ods_ir.OpView):
  ...
  @builtins.property
  def in_crds(self) -> _ods_ir.OpOperandList:
    _ods_variadic_group_length = len(self.operation.operands) - 1 + 1
    return self.operation.operands[0:0 + _ods_variadic_group_length]

  @builtins.property
  def direction(self) -> _ods_ir.Attribute:
    return self.operation.attributes["direction"]

  @direction.setter
  def direction(self, value: _ods_ir.Attribute):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["direction"] = value

  @builtins.property
  def encoder(self) -> _ods_ir.Attribute:
    return self.operation.attributes["encoder"]

  @encoder.setter
  def encoder(self, value: _ods_ir.Attribute):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["encoder"] = value

  @builtins.property
  def out_crds(self) -> _ods_ir.OpResultList:
    _ods_variadic_group_length = len(self.operation.results) - 1 + 1
    return self.operation.results[0:0 + _ods_variadic_group_length]

@_ods_cext.register_op_adaptor(CrdTranslateOp)
class CrdTranslateOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.crd_translate"
  ...
  @builtins.property
  def encoder(self) -> _ods_ir.Attribute:
    return self.attributes["encoder"]

def crd_translate(out_crds, in_crds, direction, encoder, *, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, CrdTranslateOp]:
...
class DisassembleOp(_ods_ir.OpView):
  ...
  @builtins.property
  def out_levels(self) -> _ods_ir.OpOperandList:
    _ods_variadic_group_length = len(self.operation.operands) - 3 + 1
    return self.operation.operands[1:1 + _ods_variadic_group_length]

  @builtins.property
  def out_values(self) -> _ods_ir.Value[_ods_ir.RankedTensorType]:
    _ods_variadic_group_length = len(self.operation.operands) - 3 + 1
    return self.operation.operands[2 + _ods_variadic_group_length - 1]

  @builtins.property
  def ret_levels(self) -> _ods_ir.OpResultList:
...
def disassemble(ret_levels, ret_values, lvl_lens, val_len, tensor, out_levels, out_values, *, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, DisassembleOp]:
...
class ExpandOp(_ods_ir.OpView):
  ...
  @builtins.property
  def filled(self) -> _ods_ir.OpResult[_ods_ir.MemRefType]:
    return self.operation.results[1]

  @builtins.property
  def added(self) -> _ods_ir.OpResult[_ods_ir.MemRefType]:
    return self.operation.results[2]

  @builtins.property
  def count(self) -> _ods_ir.OpResult[_ods_ir.IndexType]:
    return self.operation.results[3]

@_ods_cext.register_op_adaptor(ExpandOp)
class ExpandOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.expand"
...
def expand(values, filled, added, count, tensor, *, loc=None, ip=None) -> _ods_ir.OpResultList:
...
class ForeachOp(_ods_ir.OpView):
  ...
  @builtins.property
  def order(self) -> _Optional[_ods_ir.AffineMapAttr]:
    if "order" not in self.operation.attributes:
      return None
    return self.operation.attributes["order"]

  @order.setter
  def order(self, value: _Optional[_ods_ir.AffineMapAttr]):
...
@_ods_cext.register_op_adaptor(ForeachOp)
class ForeachOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.foreach"
  ...
  @builtins.property
  def order(self) -> _Optional[_ods_ir.AffineMapAttr]:
    if "order" not in self.attributes:
      return None
    return self.attributes["order"]

def foreach(results_, tensor, init_args, *, order=None, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, ForeachOp]:
...
class GetStorageSpecifierOp(_ods_ir.OpView):
  ...
  def __init__(self, specifier, specifierKind, *, level=None, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def specifier(self) -> _ods_ir.Value:
    return self.operation.operands[0]

  @builtins.property
  def specifierKind(self) -> _ods_ir.Attribute:
    return self.operation.attributes["specifierKind"]

  @specifierKind.setter
  def specifierKind(self, value: _ods_ir.Attribute):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["specifierKind"] = value

  @builtins.property
  def level(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "level" not in self.operation.attributes:
      return None
    return self.operation.attributes["level"]

  @level.setter
  def level(self, value: _Optional[_ods_ir.IntegerAttr]):
    if value is not None:
...
@_ods_cext.register_op_adaptor(GetStorageSpecifierOp)
class GetStorageSpecifierOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.storage_specifier.get"
  ...
  @builtins.property
  def specifierKind(self) -> _ods_ir.Attribute:
    return self.attributes["specifierKind"]

  @builtins.property
  def level(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "level" not in self.attributes:
      return None
    return self.attributes["level"]

def storage_specifier_get(specifier, specifier_kind, *, level=None, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
@_ods_cext.register_op_adaptor(HasRuntimeLibraryOp)
class HasRuntimeLibraryOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.has_runtime_library"

def has_runtime_library(*, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return HasRuntimeLibraryOp(results=results, loc=loc, ip=ip).result
...
class LoadOp(_ods_ir.OpView):
  ...
  def __init__(self, tensor, *, hasInserts=None, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(tensor)
...
class LoadOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def hasInserts(self) -> bool:
    return "hasInserts" in self.attributes

def load(tensor, *, has_inserts=None, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
@_ods_cext.register_op_adaptor(LvlOp)
class LvlOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.lvl"
...
def lvl(source, index, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
@_ods_cext.register_op_adaptor(NewOp)
class NewOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.new"
...
def new(result, source, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
@_ods_cext.register_op_adaptor(NumberOfEntriesOp)
class NumberOfEntriesOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.number_of_entries"
...
def number_of_entries(tensor, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return NumberOfEntriesOp(tensor=tensor, results=results, loc=loc, ip=ip).result
...
@_ods_cext.register_op_adaptor(OutOp)
class OutOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.out"
...
def out(tensor, dest, *, loc=None, ip=None) -> OutOp:
...
def print_(tensor, *, loc=None, ip=None) -> PrintOp:
...
class PushBackOp(_ods_ir.OpView):
  ...
  def __init__(self, curSize, inBuffer, value, *, n=None, inbounds=None, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def curSize(self) -> _ods_ir.Value[_ods_ir.IndexType]:
    return self.operation.operands[0]

  @builtins.property
  def inBuffer(self) -> _ods_ir.Value[_ods_ir.MemRefType]:
    return self.operation.operands[1]
  ...
  @builtins.property
  def n(self) -> _Optional[_ods_ir.Value[_ods_ir.IndexType]]:
  ...
  @builtins.property
  def outBuffer(self) -> _ods_ir.OpResult[_ods_ir.MemRefType]:
    return self.operation.results[0]

  @builtins.property
  def newSize(self) -> _ods_ir.OpResult[_ods_ir.IndexType]:
    return self.operation.results[1]

@_ods_cext.register_op_adaptor(PushBackOp)
class PushBackOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.push_back"
  ...
  @builtins.property
  def n(self) -> _Optional[_ods_ir.Value[_ods_ir.IndexType]]:
    return None if len(self.operands) < 4 else self.operands[3]

  @builtins.property
  def inbounds(self) -> bool:
    return "inbounds" in self.attributes

def push_back(cur_size, in_buffer, value, *, n=None, inbounds=None, results=None, loc=None, ip=None) -> _ods_ir.OpResultList:
...
class ReduceOp(_ods_ir.OpView):
  ...
  def __init__(self, x, y, identity, *, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(x)
  ...
  @builtins.property
  def identity(self) -> _ods_ir.Value:
    return self.operation.operands[2]
...
def reduce(x, y, identity, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
@_ods_cext.register_op_adaptor(ReinterpretMapOp)
class ReinterpretMapOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.reinterpret_map"
...
def reinterpret_map(dest, source, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
class ReorderCOOOp(_ods_ir.OpView):
  ...
  @builtins.property
  def input_coo(self) -> _ods_ir.Value[_ods_ir.RankedTensorType]:
    return self.operation.operands[0]

  @builtins.property
  def algorithm(self) -> _ods_ir.Attribute:
    return self.operation.attributes["algorithm"]

  @algorithm.setter
  def algorithm(self, value: _ods_ir.Attribute):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["algorithm"] = value

  @builtins.property
  def result_coo(self) -> _ods_ir.OpResult[_ods_ir.RankedTensorType]:
    return self.operation.results[0]

@_ods_cext.register_op_adaptor(ReorderCOOOp)
class ReorderCOOOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.reorder_coo"
...
def reorder_coo(result_coo, input_coo, algorithm, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def select(x, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
class SetStorageSpecifierOp(_ods_ir.OpView):
  ...
  def __init__(self, specifier, specifierKind, value, *, level=None, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(specifier)
...
@_ods_cext.register_op_adaptor(SetStorageSpecifierOp)
class SetStorageSpecifierOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.storage_specifier.set"
...
def storage_specifier_set(specifier, specifier_kind, value, *, level=None, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
class SortOp(_ods_ir.OpView):
  ...
  @builtins.property
  def n(self) -> _ods_ir.Value[_ods_ir.IndexType]:
    return self.operation.operands[0]

  @builtins.property
  def xy(self) -> _ods_ir.Value[_ods_ir.MemRefType]:
    return self.operation.operands[1]

  @builtins.property
  def ys(self) -> _ods_ir.OpOperandList:
    _ods_variadic_group_length = len(self.operation.operands) - 3 + 1
    return self.operation.operands[2:2 + _ods_variadic_group_length]

  @builtins.property
  def perm_map(self) -> _ods_ir.AffineMapAttr:
    return self.operation.attributes["perm_map"]

  @perm_map.setter
  def perm_map(self, value: _ods_ir.AffineMapAttr):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["perm_map"] = value

  @builtins.property
  def ny(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "ny" not in self.operation.attributes:
      return None
    return self.operation.attributes["ny"]

  @ny.setter
  def ny(self, value: _Optional[_ods_ir.IntegerAttr]):
    if value is not None:
...
class SortOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def perm_map(self) -> _ods_ir.AffineMapAttr:
    return self.attributes["perm_map"]

  @builtins.property
  def ny(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "ny" not in self.attributes:
      return None
    return self.attributes["ny"]

  @builtins.property
  def algorithm(self) -> _ods_ir.Attribute:
    return self.attributes["algorithm"]

def sort(n, xy, ys, perm_map, algorithm, *, ny=None, loc=None, ip=None) -> SortOp:
...
@_ods_cext.register_op_adaptor(StorageSpecifierInitOp)
class StorageSpecifierInitOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.storage_specifier.init"
...
def storage_specifier_init(result, *, source=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
@_ods_cext.register_op_adaptor(ToCoordinatesBufferOp)
class ToCoordinatesBufferOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.coordinates_buffer"
...
def coordinates_buffer(tensor, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ToCoordinatesBufferOp(tensor=tensor, results=results, loc=loc, ip=ip).result
...
class ToCoordinatesOp(_ods_ir.OpView):
  ...
  def __init__(self, tensor, level, *, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(tensor)
...
@_ods_cext.register_op_adaptor(ToCoordinatesOp)
class ToCoordinatesOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.coordinates"
...
def coordinates(tensor, level, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ToCoordinatesOp(tensor=tensor, level=level, results=results, loc=loc, ip=ip).result
...
@_ods_cext.register_op_adaptor(ToPositionsOp)
class ToPositionsOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.positions"
...
def positions(tensor, level, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
class ToSliceOffsetOp(_ods_ir.OpView):
  ...
  def __init__(self, slice, dim, *, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def slice(self) -> _ods_ir.Value[_ods_ir.RankedTensorType]:
    return self.operation.operands[0]
...
@_ods_cext.register_op_adaptor(ToSliceOffsetOp)
class ToSliceOffsetOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.slice.offset"
...
def slice_offset(slice, dim, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ToSliceOffsetOp(slice=slice, dim=dim, results=results, loc=loc, ip=ip).result
...
class ToSliceStrideOp(_ods_ir.OpView):
  ...
  @builtins.property
  def stride(self) -> _ods_ir.OpResult[_ods_ir.IndexType]:
    return self.operation.results[0]

@_ods_cext.register_op_adaptor(ToSliceStrideOp)
class ToSliceStrideOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.slice.stride"
...
def slice_stride(slice, dim, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ToSliceStrideOp(slice=slice, dim=dim, results=results, loc=loc, ip=ip).result
...
@_ods_cext.register_op_adaptor(ToValuesOp)
class ToValuesOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.values"
...
def values(tensor, *, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return ToValuesOp(tensor=tensor, results=results, loc=loc, ip=ip).result
...
class UnaryOp(_ods_ir.OpView):
  ...
  @builtins.property
  def presentRegion(self) -> _ods_ir.Region:
    return self.regions[0]

  @builtins.property
  def absentRegion(self) -> _ods_ir.Region:
    return self.regions[1]

@_ods_cext.register_op_adaptor(UnaryOp)
class UnaryOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "sparse_tensor.unary"
...
def unary(output, x, *, loc=None, ip=None) -> _ods_ir.OpResult:
