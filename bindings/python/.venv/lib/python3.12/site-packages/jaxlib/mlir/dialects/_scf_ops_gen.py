...
@_ods_cext.register_op_adaptor(ConditionOp)
class ConditionOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "scf.condition"
...
@_ods_cext.register_op_adaptor(ExecuteRegionOp)
class ExecuteRegionOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "scf.execute_region"
...
class ForOpAdaptor(_ods_ir.OpAdaptor):
  ...
  def initArgs(self) -> _ods_ir.OpOperandList:
    ...
    return self.operands[3:3 + _ods_variadic_group_length]

  @builtins.property
  def unsignedCmp(self) -> bool:
    return "unsignedCmp" in self.attributes
...
@_ods_cext.register_op_adaptor(ForallOp)
class ForallOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "scf.forall"
  ...
  @builtins.property
  def staticLowerBound(self) -> _ods_ir.DenseI64ArrayAttr:
    return self.attributes["staticLowerBound"]

  @builtins.property
  def staticUpperBound(self) -> _ods_ir.DenseI64ArrayAttr:
    return self.attributes["staticUpperBound"]

  @builtins.property
  def staticStep(self) -> _ods_ir.DenseI64ArrayAttr:
    return self.attributes["staticStep"]

  @builtins.property
  def mapping(self) -> _Optional[_ods_ir.ArrayAttr]:
    if "mapping" not in self.attributes:
      return None
    return self.attributes["mapping"]
...
@_ods_cext.register_op_adaptor(InParallelOp)
class InParallelOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "scf.forall.in_parallel"
...
@_ods_cext.register_op_adaptor(IndexSwitchOp)
class IndexSwitchOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "scf.index_switch"
...
@_ods_cext.register_op_adaptor(ParallelOp)
class ParallelOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "scf.parallel"
