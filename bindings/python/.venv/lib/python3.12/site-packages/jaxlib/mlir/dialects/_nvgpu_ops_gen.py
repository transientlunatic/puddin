...
@_ods_cext.register_op_adaptor(DeviceAsyncCopyOp)
class DeviceAsyncCopyOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.device_async_copy"
  ...
  @builtins.property
  def dstElements(self) -> _ods_ir.IntegerAttr:
    return self.attributes["dstElements"]

  @builtins.property
  def bypassL1(self) -> bool:
    return "bypassL1" in self.attributes
...
@_ods_cext.register_op_adaptor(DeviceAsyncCreateGroupOp)
class DeviceAsyncCreateGroupOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.device_async_create_group"
...
@_ods_cext.register_op_adaptor(DeviceAsyncWaitOp)
class DeviceAsyncWaitOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.device_async_wait"
  ...
  @builtins.property
  def numGroups(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "numGroups" not in self.attributes:
      return None
    return self.attributes["numGroups"]
...
class LdMatrixOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def numTiles(self) -> _ods_ir.IntegerAttr:
    return self.attributes["numTiles"]
...
@_ods_cext.register_op_adaptor(MBarrierCreateOp)
class MBarrierCreateOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.mbarrier.create"
...
@_ods_cext.register_op_adaptor(MBarrierGetOp)
class MBarrierGetOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.mbarrier.get"
...
@_ods_cext.register_op_adaptor(MmaSparseSyncOp)
class MmaSparseSyncOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.mma.sp.sync"
  ...
  @builtins.property
  def mmaShape(self) -> _ods_ir.ArrayAttr:
    return self.attributes["mmaShape"]

  @builtins.property
  def sparsitySelector(self) -> _ods_ir.IntegerAttr:
    return self.attributes["sparsitySelector"]

  @builtins.property
  def tf32Enabled(self) -> bool:
    return "tf32Enabled" in self.attributes
...
@_ods_cext.register_op_adaptor(MmaSyncOp)
class MmaSyncOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.mma.sync"
...
@_ods_cext.register_op_adaptor(RcpOp)
class RcpOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.rcp"
...
@_ods_cext.register_op_adaptor(TmaAsyncLoadOp)
class TmaAsyncLoadOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.tma.async.load"
...
@_ods_cext.register_op_adaptor(TmaAsyncStoreOp)
class TmaAsyncStoreOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.tma.async.store"
...
@_ods_cext.register_op_adaptor(TmaCreateDescriptorOp)
class TmaCreateDescriptorOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.tma.create.descriptor"
...
@_ods_cext.register_op_adaptor(TmaFenceOp)
class TmaFenceOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.tma.fence.descriptor"
...
@_ods_cext.register_op_adaptor(TmaPrefetchOp)
class TmaPrefetchOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.tma.prefetch.descriptor"
...
@_ods_cext.register_op_adaptor(WarpgroupGenerateDescriptorOp)
class WarpgroupGenerateDescriptorOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.warpgroup.generate.descriptor"
...
@_ods_cext.register_op_adaptor(WarpgroupMmaInitAccumulatorOp)
class WarpgroupMmaInitAccumulatorOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.warpgroup.mma.init.accumulator"
...
@_ods_cext.register_op_adaptor(WarpgroupMmaOp)
class WarpgroupMmaOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.warpgroup.mma"
  ...
  @builtins.property
  def waitGroup(self) -> _Optional[_ods_ir.IntegerAttr]:
    if "waitGroup" not in self.attributes:
      return None
    return self.attributes["waitGroup"]

  @builtins.property
  def transposeA(self) -> bool:
    return "transposeA" in self.attributes

  @builtins.property
  def transposeB(self) -> bool:
    return "transposeB" in self.attributes
...
@_ods_cext.register_op_adaptor(WarpgroupMmaStoreOp)
class WarpgroupMmaStoreOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "nvgpu.warpgroup.mma.store"
