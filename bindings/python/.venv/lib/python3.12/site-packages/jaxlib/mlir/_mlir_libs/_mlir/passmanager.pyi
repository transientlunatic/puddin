...
class PassManager:
    def __init__(self, anchor_op: str = 'any', context: jaxlib.ir.Context | None = None) -> None:
    ...
    @staticmethod
    def parse(pipeline: str, context: jaxlib.ir.Context | None = None) -> PassManager:
        """
    ...
    def run(self, operation: jaxlib.ir._OperationBase) -> None:
        """
