...
class CompositeOp(_ods_ir.OpView):
  ...
  def __init__(self, result, inputs, name, decomposition, num_composite_regions, *, composite_attributes=None, version=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.extend(_get_op_results_or_values(inputs))
...
def composite(result, inputs, name, decomposition, num_composite_regions, *, composite_attributes=None, version=None, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, CompositeOp]:
...
class CustomCallOp(_ods_ir.OpView):
  ...
  def __init__(self, result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, custom_call_schedule=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if backend_config is not None: attributes["backend_config"] = (backend_config if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_870')) else
          _ods_ir.AttrBuilder.get('anonymous_870')(backend_config, context=_ods_context))
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_877')) else
          _ods_ir.AttrBuilder.get('anonymous_877')(output_operand_aliases, context=_ods_context))
    results = []
    results.extend(result)
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
class FusionOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, inputs, *, fusion_kind=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        isinstance(output_operand_aliases, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_913')) else
          _ods_ir.AttrBuilder.get('anonymous_913')(output_operand_aliases, context=_ods_context))
    results = []
...
class ScanOp(_ods_ir.OpView):
  ...
  def __init__(self, outputs, carries, inputs, inits, dimension, *, is_reverse=None, is_associative=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
...
def scan(outputs, carries, inputs, inits, dimension, *, is_reverse=None, is_associative=None, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, ScanOp]:
