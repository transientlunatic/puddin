...
class ExtUIOp(_ods_ir.OpView):
  ...
  def __init__(self, out, in_, *, nonNeg=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(in_)
...
def extui(out, in_, *, non_neg=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def index_castui(out, in_, *, non_neg=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def uitofp(out, in_, *, non_neg=None, loc=None, ip=None) -> _ods_ir.OpResult:
