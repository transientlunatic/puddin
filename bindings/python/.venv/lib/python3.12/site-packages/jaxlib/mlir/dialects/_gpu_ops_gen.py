...
class BarrierOp(_ods_ir.OpView):
  ...
  def __init__(self, *, address_spaces=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    _ods_context = _ods_get_default_loc_context(loc)
...
def barrier(*, address_spaces=None, loc=None, ip=None) -> BarrierOp:
...
class GPUFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, workgroup_attrib_attrs=None, private_attrib_attrs=None, known_block_size=None, known_grid_size=None, known_cluster_size=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    _ods_context = _ods_get_default_loc_context(loc)
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_650')) else
      _ods_ir.AttrBuilder.get('anonymous_650')(function_type, context=_ods_context))
...
def func(function_type, *, arg_attrs=None, res_attrs=None, workgroup_attrib_attrs=None, private_attrib_attrs=None, known_block_size=None, known_grid_size=None, known_cluster_size=None, loc=None, ip=None) -> GPUFuncOp:
