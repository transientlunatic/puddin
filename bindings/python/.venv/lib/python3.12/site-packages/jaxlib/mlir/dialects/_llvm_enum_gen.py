...
class DenormalModeKind(IntEnum):
    ...
    def __str__(self):
        if self is DenormalModeKind.IEEE:
            return "ieee"
        if self is DenormalModeKind.PreserveSign:
            return "preservesign"
        if self is DenormalModeKind.PositiveZero:
            return "positivezero"
        if self is DenormalModeKind.Dynamic:
            return "dynamic"
        if self is DenormalModeKind.Invalid:
            return "invalid"
        raise ValueError("Unknown DenormalModeKind enum entry.")



@register_attribute_builder("DenormalModeKindAttr")
...
class FramePointerKind(IntEnum):
    ...
    def __str__(self):
        ...
        if self is FramePointerKind.Reserved:
            return "reserved"
        if self is FramePointerKind.NonLeafNoReserve:
