...
class ScatterOp(_ods_ir.OpView):
  ...
  def __init__(self, result, base, offsets, indices, mask, valueToStore, *, alignment=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(base)
...
def scatter(result, base, offsets, indices, mask, value_to_store, *, alignment=None, loc=None, ip=None) -> _Union[_ods_ir.OpResult, _ods_ir.OpResultList, ScatterOp]:
