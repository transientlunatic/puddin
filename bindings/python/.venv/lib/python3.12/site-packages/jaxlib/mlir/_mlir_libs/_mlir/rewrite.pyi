...
class PatternRewriter:
    @property
    def ip(self) -> jaxlib.ir.InsertionPoint:
        """The current insertion point of the PatternRewriter."""

    @overload
    def replace_op(self, op: jaxlib.ir._OperationBase, new_op: jaxlib.ir._OperationBase) -> None:
        """Replace an operation with a new operation."""

    @overload
    def replace_op(self, op: jaxlib.ir._OperationBase, values: Sequence[jaxlib.ir.Value]) -> None:
        """Replace an operation with a list of values."""

    def erase_op(self, op: jaxlib.ir._OperationBase) -> None:
        """Erase an operation."""
...
class ConversionPatternRewriter(PatternRewriter):
    def convert_region_types(self, arg0: jaxlib.ir.Region, arg1: TypeConverter, /) -> None: ...
...
class TypeConverter:
    ...
    def convert_type(self, type: jaxlib.ir.Type) -> jaxlib.ir.Type | None:
        """Convert the given type. Returns None if conversion fails."""

class PDLResultList:
    @overload
    def append(self, arg: jaxlib.ir.Value, /) -> None: ...

    @overload
    def append(self, arg: jaxlib.ir.Operation, /) -> None: ...

    @overload
    def append(self, arg: jaxlib.ir.Type, /) -> None: ...

    @overload
    def append(self, arg: jaxlib.ir.Attribute, /) -> None: ...

class PDLModule:
    @overload
    def __init__(self, module: jaxlib.ir.Module) -> None:
...
@overload
def apply_patterns_and_fold_greedily(module: jaxlib.ir.Module, set: FrozenRewritePatternSet, config: GreedyRewriteConfig | None = None) -> None:
    """
    Applys the given patterns to the given module greedily while folding results.
    """

@overload
def apply_patterns_and_fold_greedily(op: jaxlib.ir._OperationBase, set: FrozenRewritePatternSet, config: GreedyRewriteConfig | None = None) -> None:
    """
    Applys the given patterns to the given op greedily while folding results.
    """

def walk_and_apply_patterns(op: jaxlib.ir._OperationBase, set: FrozenRewritePatternSet) -> None:
    """
    Applies the given patterns to the given op by a fast walk-based driver.
    """

def apply_partial_conversion(op: jaxlib.ir._OperationBase, target: ConversionTarget, set: FrozenRewritePatternSet, config: ConversionConfig | None = None) -> None:
    """Applies a partial conversion on the given operation."""

def apply_full_conversion(op: jaxlib.ir._OperationBase, target: ConversionTarget, set: FrozenRewritePatternSet, config: ConversionConfig | None = None) -> None:
