...
@_ods_cext.register_op_adaptor(AssumeAlignmentOp)
class AssumeAlignmentOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.assume_alignment"
...
@_ods_cext.register_op_adaptor(AtomicYieldOp)
class AtomicYieldOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.atomic_yield"
...
@_ods_cext.register_op_adaptor(DistinctObjectsOp)
class DistinctObjectsOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.distinct_objects"
...
@_ods_cext.register_op_adaptor(GenericAtomicRMWOp)
class GenericAtomicRMWOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.generic_atomic_rmw"
...
@_ods_cext.register_op_adaptor(AllocaScopeOp)
class AllocaScopeOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.alloca_scope"
...
@_ods_cext.register_op_adaptor(AllocaScopeReturnOp)
class AllocaScopeReturnOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.alloca_scope.return"
...
@_ods_cext.register_op_adaptor(CastOp)
class CastOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.cast"
...
@_ods_cext.register_op_adaptor(CollapseShapeOp)
class CollapseShapeOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.collapse_shape"
  ...
  @builtins.property
  def reassociation(self) -> _ods_ir.ArrayAttr:
    return self.attributes["reassociation"]
...
@_ods_cext.register_op_adaptor(DimOp)
class DimOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.dim"
...
@_ods_cext.register_op_adaptor(DmaStartOp)
class DmaStartOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.dma_start"
...
class DmaWaitOp(_ods_ir.OpView):
  ...
  @builtins.property
  def tagMemRef(self) -> _ods_ir.Value[_ods_ir.MemRefType]:
    return self.operation.operands[0]
  ...
  @builtins.property
  def numElements(self) -> _ods_ir.Value[_ods_ir.IndexType]:
    _ods_variadic_group_length = len(self.operation.operands) - 3 + 1
    return self.operation.operands[2 + _ods_variadic_group_length - 1]

@_ods_cext.register_op_adaptor(DmaWaitOp)
class DmaWaitOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.dma_wait"
...
@_ods_cext.register_op_adaptor(ExpandShapeOp)
class ExpandShapeOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.expand_shape"
  ...
  @builtins.property
  def static_output_shape(self) -> _ods_ir.DenseI64ArrayAttr:
    return self.attributes["static_output_shape"]
...
class ExtractAlignedPointerAsIndexOp(_ods_ir.OpView):
  ...
  @builtins.property
  def aligned_pointer(self) -> _ods_ir.OpResult[_ods_ir.IndexType]:
    return self.operation.results[0]

@_ods_cext.register_op_adaptor(ExtractAlignedPointerAsIndexOp)
class ExtractAlignedPointerAsIndexOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.extract_aligned_pointer_as_index"
...
@_ods_cext.register_op_adaptor(ExtractStridedMetadataOp)
class ExtractStridedMetadataOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.extract_strided_metadata"
...
@_ods_cext.register_op_adaptor(GetGlobalOp)
class GetGlobalOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.get_global"
...
class GlobalOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def initial_value(self) -> _Optional[_ods_ir.Attribute]:
    if "initial_value" not in self.attributes:
      return None
    return self.attributes["initial_value"]
...
@_ods_cext.register_op_adaptor(MemorySpaceCastOp)
class MemorySpaceCastOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.memory_space_cast"
...
class PrefetchOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def isWrite(self) -> _ods_ir.BoolAttr:
    return self.attributes["isWrite"]

  @builtins.property
  def localityHint(self) -> _ods_ir.IntegerAttr:
    return self.attributes["localityHint"]

  @builtins.property
  def isDataCache(self) -> _ods_ir.BoolAttr:
    return self.attributes["isDataCache"]
...
@_ods_cext.register_op_adaptor(RankOp)
class RankOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.rank"
...
class ReallocOp(_ods_ir.OpView):
  ...
  @builtins.property
  def dynamicResultSize(self) -> _Optional[_ods_ir.Value[_ods_ir.IndexType]]:
...
@_ods_cext.register_op_adaptor(ReallocOp)
class ReallocOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.realloc"
...
class ReinterpretCastOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def static_offsets(self) -> _ods_ir.DenseI64ArrayAttr:
    return self.attributes["static_offsets"]

  @builtins.property
  def static_sizes(self) -> _ods_ir.DenseI64ArrayAttr:
    return self.attributes["static_sizes"]

  @builtins.property
  def static_strides(self) -> _ods_ir.DenseI64ArrayAttr:
    return self.attributes["static_strides"]
...
class ReshapeOp(_ods_ir.OpView):
  ...
  @builtins.property
  def shape(self) -> _ods_ir.Value[_ods_ir.MemRefType]:
    return self.operation.operands[1]
...
class TransposeOp(_ods_ir.OpView):
  ...
  @builtins.property
  def in_(self) -> _ods_ir.Value[_ods_ir.MemRefType]:
    return self.operation.operands[0]
...
class ViewOp(_ods_ir.OpView):
  ...
  * A dynamic size operand that must be specified for each dynamic dimension
  ...
  @builtins.property
  def byte_shift(self) -> _ods_ir.Value[_ods_ir.IndexType]:
    return self.operation.operands[1]
...
@_ods_cext.register_op_adaptor(ViewOp)
class ViewOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.view"
...
@_ods_cext.register_op_adaptor(SubViewOp)
class SubViewOpAdaptor(_ods_ir.OpAdaptor):
  OPERATION_NAME = "memref.subview"
