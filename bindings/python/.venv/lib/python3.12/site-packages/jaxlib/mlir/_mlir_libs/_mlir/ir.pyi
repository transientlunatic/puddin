...
class Operation(_OperationBase):
    @staticmethod
    def create(name: str, results: Sequence[Type] | None = None, operands: Sequence[Value] | None = None, attributes: dict | None = None, successors: Sequence[Block] | None = None, regions: int = 0, loc: Location | None = None, ip: object | None = None, infer_type: bool = False) -> Operation:
        """
...
class OpView(_OperationBase):
    ...
    def build_generic(*args, **kwargs):
        """
        (cls: object, results: list | None = None, operands: list | None = None, attributes: dict | None = None, successors: collections.abc.Sequence[jaxlib.ir.Block] | None = None, regions: int | None = None, loc: jaxlib.ir.Location | None = None, ip: object | None = None) -> object
    ...
    def parse(*args, **kwargs):
        r"""
        (cls: object, source: str, *, source_name: str = \'\', context: _ir.Context | None = None) -> jaxlib.ir.OpView
...
class DynamicOpTrait:
    ...
    def attach(*args, **kwargs):
        """
        (cls: object, op_name: object, target: object | None = None, context: _ir.Context | None = None) -> bool
...
class IsTerminatorTrait(DynamicOpTrait):
    ...
    def attach(*args, **kwargs):
        """
        (cls: object, op_name: object, context: _ir.Context | None = None) -> bool
...
class AffineMap:
    ...
    @staticmethod
    def compress_unused_symbols(arg0: list, arg1: _ir.Context, /) -> list[AffineMap]: ...
    ...
    @staticmethod
    def get(dim_count: int, symbol_count: int, exprs: list, context: _ir.Context | None = None) -> AffineMap:
...
class IntegerSet:
    ...
    @staticmethod
    def get(num_dims: int, num_symbols: int, exprs: list, eq_flags: Sequence[bool], context: _ir.Context | None = None) -> IntegerSet: ...
...
class ArrayAttr(Attribute):
    ...
    @staticmethod
    def get(attributes: list, context: _ir.Context | None = None) -> ArrayAttr:
...
class DenseFPElementsAttr(DenseElementsAttr):
    ...
    @overload
    @staticmethod
    def get(array: typing_extensions.Buffer, signless: bool = True, type: Type | None = None, shape: Sequence[int] | None = None, context: Context | None = None) -> DenseFPElementsAttr:
        """
        Gets a DenseElementsAttr from a Python buffer or array.
...
class DenseIntElementsAttr(DenseElementsAttr):
    ...
    @overload
    @staticmethod
    def get(array: typing_extensions.Buffer, signless: bool = True, type: Type | None = None, shape: Sequence[int] | None = None, context: Context | None = None) -> DenseIntElementsAttr:
        """
        Gets a DenseElementsAttr from a Python buffer or array.
...
class DictAttr(Attribute):
    ...
    @staticmethod
    def get(value: dict = {}, context: _ir.Context | None = None) -> DictAttr:
...
class InferShapedTypeOpInterface:
    ...
    def inferReturnTypeComponents(self, operands: list | None = None, attributes: Attribute | None = None, regions: typing_extensions.CapsuleType | None = None, properties: Sequence[Region] | None = None, context: _ir.Context | None = None, loc: _ir.Location | None = None) -> list[ShapedTypeComponents]:
        """
...
class InferTypeOpInterface:
    ...
    def inferReturnTypes(self, operands: list | None = None, attributes: Attribute | None = None, properties: typing_extensions.CapsuleType | None = None, regions: Sequence[Region] | None = None, context: _ir.Context | None = None, loc: _ir.Location | None = None) -> list[Type]:
        """
        Given the arguments required to build an operation, attempts to infer
...
class MemoryEffectsOpInterface:
    ...
    def attach(*args, **kwargs):
        """
        (cls: object, op_name: object, *, target: object | None = None, context: _ir.Context | None = None) -> None
...
class VectorType(ShapedType):
    ...
    @staticmethod
    def get(shape: Sequence[int], element_type: Type, *, scalable: list | None = None, scalable_dims: Sequence[int] | None = None, loc: _ir.Location | None = None) -> VectorType:
        """Create a vector type"""

    @staticmethod
    def get_unchecked(shape: Sequence[int], element_type: Type, *, scalable: list | None = None, scalable_dims: Sequence[int] | None = None, context: _ir.Context | None = None) -> VectorType:
        """Create a vector type"""
