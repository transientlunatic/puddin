...
class CallOp(_ods_ir.OpView):
  ...
  def __init__(self, result, callee_operands, op_bundle_operands, op_bundle_sizes, *, var_callee_type=None, callee=None, fastmathFlags=None, CConv=None, TailCallKind=None, memory_effects=None, convergent=None, no_unwind=None, will_return=None, noreturn=None, returns_twice=None, hot=None, cold=None, noduplicate=None, no_caller_saved_registers=None, nocallback=None, modular_format=None, nobuiltins=None, allocsize=None, optsize=None, minsize=None, builtin=None, nobuiltin=None, save_reg_params=None, zero_call_used_regs=None, trap_func_name=None, default_func_attrs=None, op_bundle_tags=None, arg_attrs=None, res_attrs=None, no_inline=None, always_inline=None, inline_hint=None, access_groups=None, alias_scopes=None, noalias_scopes=None, tbaa=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    ...
    if var_callee_type is not None: attributes["var_callee_type"] = (var_callee_type if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_1001')) else
          _ods_ir.AttrBuilder.get('anonymous_1001')(var_callee_type, context=_ods_context))
...
class LLVMFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, sym_visibility=None, linkage=None, dso_local=None, CConv=None, comdat=None, convergent=None, personality=None, garbageCollector=None, passthrough=None, arg_attrs=None, res_attrs=None, function_entry_count=None, memory_effects=None, visibility_=None, arm_streaming=None, arm_locally_streaming=None, arm_streaming_compatible=None, arm_new_za=None, arm_in_za=None, arm_out_za=None, arm_inout_za=None, arm_preserves_za=None, section=None, unnamed_addr=None, alignment=None, vscale_range=None, frame_pointer=None, target_cpu=None, tune_cpu=None, reciprocal_estimates=None, prefer_vector_width=None, target_features=None, no_nans_fp_math=None, no_signed_zeros_fp_math=None, denormal_fpenv=None, fp_contract=None, instrument_function_entry=None, instrument_function_exit=None, no_inline=None, always_inline=None, inline_hint=None, no_unwind=None, will_return=None, noreturn=None, optimize_none=None, returns_twice=None, hot=None, cold=None, noduplicate=None, no_caller_saved_registers=None, nocallback=None, modular_format=None, nobuiltins=None, allocsize=None, optsize=None, minsize=None, save_reg_params=None, zero_call_used_regs=None, default_func_attrs=None, vec_type_hint=None, work_group_size_hint=None, reqd_work_group_size=None, intel_reqd_sub_group_size=None, uwtable_kind=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1001')) else
      _ods_ir.AttrBuilder.get('anonymous_1001')(function_type, context=_ods_context))
...
class LLVMFuncOpAdaptor(_ods_ir.OpAdaptor):
  ...
  @builtins.property
  def no_nans_fp_math(self) -> _Optional[_ods_ir.BoolAttr]:
    if "no_nans_fp_math" not in self.attributes:
      return None
    return self.attributes["no_nans_fp_math"]
...
def ptrtoaddr(res, arg, *, loc=None, ip=None) -> _ods_ir.OpResult:
