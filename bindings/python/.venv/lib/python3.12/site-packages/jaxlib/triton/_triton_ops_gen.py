...
class LoadOp(_ods_ir.OpView):
  ...
  def __init__(self, ptr, *, mask=None, other=None, cache=None, evict=None, isVolatile=None, results=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(ptr)
...
def load(ptr, *, mask=None, other=None, cache=None, evict=None, is_volatile=None, results=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
class StoreOp(_ods_ir.OpView):
  ...
  def __init__(self, ptr, value, *, mask=None, cache=None, evict=None, loc=None, ip=None):
    operands = []
    attributes = {}
    regions = None
    operands.append(ptr)
...
def store(ptr, value, *, mask=None, cache=None, evict=None, loc=None, ip=None) -> StoreOp:
  return StoreOp(ptr=ptr, value=value, mask=mask, cache=cache, evict=evict, loc=loc, ip=ip)
